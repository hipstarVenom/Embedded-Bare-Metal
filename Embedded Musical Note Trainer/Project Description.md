This project is an embedded system designed to demonstrate the generation of musical notes with synchronized visual feedback. 
A 74HC595 serial-in parallel-out shift register is used to control multiple LEDs, each representing a musical note (Sa, Re, Ga, Ma, Pa).
